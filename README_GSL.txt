		...
		##											##
		##	GSL IS ONlY AVAILABLE WITH CLOZURE COMMON LISP					##
		##											##
		##											##
	...
	##------------------------------------------------------------------------------------------------##
		...
		Unfortunately at the moment GSL is only available in Clozure Common Lisp:
	...
	##------------------------------------------------------------------------------------------------##
		...
		4) Write a main.lisp or other file and load in the "gsl.lisp" file.
	...
	##------------------------------------------------------------------------------------------------##
		...
		If you have any trouble with this, send me an e-mail. I'm travelling around europe at the moment so it might be a couple 
		of days till I reply but I would love to help!
