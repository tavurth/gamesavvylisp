...
(setf *grass01*  (gsl-load-tex "grass.tga"))
(setf *sand01*   (gsl-load-tex "sand.tga"))
(setf *house01*  (gsl-load-tex "house.tga"))

(setf *rect1* (gsl-make-rect 50 0 50 50))
(setf *rect2* (gsl-make-rect -50 -50 50 100))
(setf *font1* (gsl-new-font "font"))
